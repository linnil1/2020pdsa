...
/*
dk openjdk:14-slim javac -cp gson.jar:algs4.jar:. mountains.sol.java mountains.judge.java Judger.java
...
class Judge extends Judger<Integer> {
    ...
    @Override protected Integer run(JsonElement ele) {
        Data d = this.gson.fromJson(ele, Data.class);
        this.resetTime();
        return new Mountains().mountains(d.mountains);
    }
