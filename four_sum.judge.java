...
/*
dk openjdk:14-slim javac -cp gson.jar:algs4.jar:. four_sum.judge.java four_sum.sol.java Judger.java
...
class Judge extends Judger<List<int[]>> {
    ...
    @Override protected List<int[]> run(JsonElement ele) {
        ...
        return new Solution().fourSum(s.nums, s.target);
    }
